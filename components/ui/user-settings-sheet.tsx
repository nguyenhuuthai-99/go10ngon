...
export default function UserSettingsSheet() {
  ...
  return (
    <div>
      <div className="mx-2 space-y-8 rounded-lg bg-white p-6 shadow dark:bg-gray-950">
              ...
              <div className="grid grid-cols-1 gap-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="showPerformanceHUD">
                      Hiển thị hiệu suất
                    </Label>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="showTypingPreview">
                      Hiển thị đối chiếu
                    </Label>
                    <p className="text-xs text-gray-500">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="markParent">
                      Đánh dấu chữ khiếm khuyết
                    </Label>
                    <p className="text-xs text-gray-500">
